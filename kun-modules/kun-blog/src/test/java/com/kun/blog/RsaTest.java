...
//        System.out.println(decode);
        System.out.println(DateUtil.betweenDay(DateUtil.parseDate("2020-2-3"), DateUtil.parseDate("2021-1-1"), true));
        System.out.println(DateUtil.betweenDay(DateUtil.parseDate("2021-1-2"), DateUtil.parseDate("2022-1-1"), true));
        System.out.println(DateUtil.betweenDay(DateUtil.parseDate("2022-1-2"), DateUtil.parseDate("2022-10-31"), true));
    }
